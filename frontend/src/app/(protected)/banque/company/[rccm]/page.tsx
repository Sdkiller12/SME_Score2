...
import { Landmark, LogOut, ArrowLeft, Loader2, QrCode, Building2 } from 'lucide-react'
      ...
      <header className="bg-white border-b">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Link href="/banque" className="flex items-center gap-2">
      ...
      <main className="container mx-auto px-4 py-8">
        {loading ? (
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-xl shadow-sm border p-6 mb-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div>
                  <div className="text-sm text-gray-500">Validité</div>
          ...
          <div className="text-center py-12">
            ...
            <Link href="/banque" className="text-blue-600 hover:underline mt-2 inline-block">
              Retour
            </Link>
          </div>
        )}
